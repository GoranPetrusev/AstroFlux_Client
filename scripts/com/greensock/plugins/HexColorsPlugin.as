package com.greensock.plugins
{
   ...
   public class HexColorsPlugin extends TweenPlugin
   {
      ...
      public function _initColor(param1:Object, param2:String, param3:uint) : void
      {
         ...
         var _loc6_:* = 0;
         var _loc7_:uint;
         if((_loc7_ = uint(!(_loc8_ = typeof param1[param2] == "function") ? param1[param2] : param1[param2.indexOf("set") || !("get" + param2.substr(3) in param1) ? param2 : "get" + param2.substr(3)]())) != param3)
         {
            _loc6_ = uint(_loc7_ >> 16);
            var _loc4_:uint = uint(_loc7_ >> 8 & 255);
            var _loc5_:uint = uint(_loc7_ & 255);
