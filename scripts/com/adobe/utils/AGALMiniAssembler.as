package com.adobe.utils
{
   ...
   public class AGALMiniAssembler
   {
      ...
      public function assemble(param1:String, param2:String, param3:uint = 1, param4:Boolean = false) : ByteArray
      {
               ...
               else
               {
                  ...
                  while(_loc43_ < _loc49_)
                  {
                     ...
                     if(_loc50_)
                     {
                        ...
                        {
                           if((_loc47_ = _loc50_[0].charCodeAt(_loc46_) - "x".charCodeAt(0)) > 2)
                           {
                              _loc47_ = 3;
                           }
                           if(_loc31_)
                     ...
                     if(_loc25_)
                     {
                        ...
                        if((_loc45_ = _loc37_[0].charCodeAt(1) - "x".charCodeAt(0)) > 2)
                        {
                           _loc45_ = 3;
                        }
         ...
         if(debugEnabled)
         {
            ...
            while(_loc22_ < _loc33_)
            {
               ...
               if((_loc20_ = String(agalcode[_loc22_].toString(16))).length < 2)
               {
                  _loc20_ = "0" + _loc20_;
               }
               _loc28_ += _loc20_;
      ...
      {
         REGMAP["va"] = new Register("va","vertex attribute",0,param2 ? 1024 : (param1 == 1 || param1 == 2 ? 7 : 15),64 | 2);
         REGMAP["vc"] = new Register("vc","vertex constant",1,param2 ? 1024 : (param1 == 1 ? 127 : 249),64 | 2);
         REGMAP["vt"] = new Register("vt","vertex temporary",2,param2 ? 1024 : (param1 == 1 ? 7 : 25),64 | 1 | 2);
         REGMAP["vo"] = new Register("vo","vertex output",3,param2 ? 1024 : 0,64 | 1);
         REGMAP["vi"] = new Register("vi","varying",4,param2 ? 1024 : (param1 == 1 ? 7 : 9),64 | 32 | 2 | 1);
         REGMAP["fc"] = new Register("fc","fragment constant",1,param2 ? 1024 : (param1 == 1 ? 27 : (param1 == 2 ? 63 : 199)),32 | 2);
         REGMAP["ft"] = new Register("ft","fragment temporary",2,param2 ? 1024 : (param1 == 1 ? 7 : 25),32 | 1 | 2);
