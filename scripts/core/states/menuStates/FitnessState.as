package core.states.menuStates
{
   ...
   public class FitnessState extends DisplayState
   {
      ...
      override public function enter() : void
      {
         ...
         addChild(divider);
         addHeader("Fitness Weights",20,386);
         addFitnessWeight("# Health",healthAdd,"healthAdd");
         addFitnessWeight("% Health",healthMulti,"healthMulti");
         addFitnessWeight("# Armor",armorAdd,"armorAdd");
         addFitnessWeight("% Armor",armorMulti,"armorMulti");
         addFitnessWeight("# Corrosive",corrosiveAdd,"corrosiveAdd");
         addFitnessWeight("% Corrosive",corrosiveMulti,"corrosiveMulti");
         addFitnessWeight("# Energy",energyAdd,"energyAdd");
         addFitnessWeight("% Energy",energyMulti,"energyMulti");
         addFitnessWeight("# Kinetic",kineticAdd,"kineticAdd");
         addFitnessWeight("% Kinetic",kineticMulti,"kineticMulti");
         addFitnessWeight("# Shield",shieldAdd,"shieldAdd");
         addFitnessWeight("% Shield",shieldMulti,"shieldMulti");
         ...
         addFitnessWeight("# All Damage",allAdd,"allAdd");
         addFitnessWeight("% All Damage",allMulti,"allMulti");
         addFitnessWeight("Speed",speed,"speed");
         addFitnessWeight("Rate of Fire",refire,"refire");
         addFitnessWeight("HP to SH",convHp,"convHp");
         addFitnessWeight("SH to HP",convShield,"convShield");
         addFitnessWeight("Power Regen",powerReg,"powerReg");
         addFitnessWeight("Max Power",powerMax,"powerMax");
