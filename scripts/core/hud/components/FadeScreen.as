package core.hud.components
{
   ...
   public class FadeScreen extends EventDispatcher
   {
      ...
      public function FadeScreen(param1:Stage)
      {
         ...
         resize();
         texts.push([["Press C if you want to know how many minerals you have."]], [["Press X or ESC if you want to see your ship summary."]], [["Check out the game wiki at wiki.astroflux.net"]], [["Watch out for those pesky comets."]], [["You can unlock artifact slots in the ship menu."]], [["Not all offers are good..."]], [["Crew members will increase their skill while exploring."]], [["News and updates on forum.astroflux.net"]], [["You lose all junk when you die. All your minerals are safe."]], [["Whatever you do, don't fly into the sun."]], [["I am busy computing.."]], [["Improve your armor to reduce damage taken by that amount."]], [["Power regenerates more slowly when the gauge turns red."]], [["Group up with players and share XP."]], [["Recycle artifacts and collect minerals."]], [["Your game is automatically saved."]], [["Enemies drop 25% more junk in pvp systems."]], [["Press enter to start chatting."]]);
textsPvp.push([["End of season rewards: 100-1000 Flux for the top 500 players!"]], [["Defeting a player with much lower Rating yeilds nothing."]], [["Match making is based on player Rating."]], [["A zone with players from both teams doesn't generate points."]], [["Holding all zones at the same time generates 3x more points."]], [["The PvP-ladder resets each new month."]]);
